...
public class AllMediaFilesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = AllMediaFilesActivity.this;
		getAllMediaImages();
	}
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					String token = InstagramApp.getInstance(AllMediaFilesActivity.this).getTOken();
